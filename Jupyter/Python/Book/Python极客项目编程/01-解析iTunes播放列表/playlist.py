...
def findCommonTracks(fileNames):
    ...
    for fileName in fileNames:
        ...
        trackNames = set()
        # read in playlist
        # plist = plistlib.readPlist(fileName)  # DeprecationWarning: The readPlist function is deprecated, use load() instead
        # plist = plistlib.load(fileName)       # AttributeError: 'str' object has no attribute 'read'
