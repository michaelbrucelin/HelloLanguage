...
function MyRecord-SSDSmart() {
    ...
    $DownloadLocation = "$($Env:OneDrive)\文档\powershell\CrystalDiskInfo_Home"
    ...
    $DiskInfoRaw = Get-Content "$($DownloadLocation)\DiskInfo.txt" | Select-String "^ \(01\) Samsung SSD 870 EVO 1TB$" -Context 0, 41
