package com.itheima.d14_iostream;
 ...
 * 源文件：  D:\PATH\TO\BIGFILE.avi
 * 目标文件：D:\PATH\TO\
 * 小结：
 * ----使用高级的缓冲字节流按照一个一个字节数组的形式复制文件，性能好，建议开发使用！
 */
public class ByteBufferTimeDemo {
    private static final String SRC_FILE = "D:\\PATH\\TO\\BIGFILE.avi";
    private static final String DST_FILE = "D:\\PATH\\TO\\";
    ...
    private static void copy01() {
        ...
        try (
                ...
                // 2、创建低级的字节输出流与目标文件接通
                OutputStream os = new FileOutputStream(DST_FILE + "video1.avi")) {
    ...
    private static void copy02() {
        ...
        try (
                ...
                OutputStream os = new FileOutputStream(DST_FILE + "video2.avi")) {
            // 3、定义一个字节数组转移数据
    ...
    private static void copy03() {
        ...
        try (
                ...
                // 2、创建低级的字节输出流与目标文件接通
                OutputStream os = new FileOutputStream(DST_FILE + "video3.avi");
    ...
    private static void copy04() {
        ...
        try (
                ...
                InputStream bis = new BufferedInputStream(is);
                // 2、创建低级的字节输出流与目标文件接通
                OutputStream os = new FileOutputStream(DST_FILE + "video4.avi");
                // b.把字节输出流管道包装成高级的缓冲字节输出流管道
                OutputStream bos = new BufferedOutputStream(os);) {
