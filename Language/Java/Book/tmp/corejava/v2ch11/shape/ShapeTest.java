 ...
 * with starting and
 * ending angles given by lines emanating from the center of the bounding box
 * and ending in two
 * given points. To show the correctness of the angle computation, the returned
 * shape contains the
