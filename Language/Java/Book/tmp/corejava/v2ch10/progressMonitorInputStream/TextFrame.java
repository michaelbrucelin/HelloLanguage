 ...
 * contents. The text area is
 * constructed when the file is loaded and set as the content pane of the frame
 * when the loading is
...
public class TextFrame extends JFrame {
    ...
    /**
     * Prompts the user to select a file, loads the file into a text area, and sets
     * it as the content
     * pane of the frame.
     */
