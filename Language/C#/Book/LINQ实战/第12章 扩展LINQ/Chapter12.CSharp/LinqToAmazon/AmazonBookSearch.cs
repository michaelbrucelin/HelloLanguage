...
namespace LinqInAction.Chapter12.LinqToAmazon
{
    public class AmazonBookSearch : IEnumerable<AmazonBook>
    {
        ...
        public AmazonBookSearch Where(Expression<Func<AmazonBook, Boolean>> predicate)
        {
            _Criteria = new AmazonBookExpressionVisitor().ProcessExpression(predicate);
            return this;
        }

        public AmazonBookSearch Select<TResult>(Expression<Func<AmazonBook, TResult>> selector)
        {
            return this;
        }
