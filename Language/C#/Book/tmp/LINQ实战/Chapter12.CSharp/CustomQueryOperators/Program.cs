...
namespace Chapter12.CustomQueryOperators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var publishers = from publisher in SampleData.Publishers
            ...
            Console.WriteLine("Book with the lowest number of pages = {0} ({1} pages)", minBook.Title, minBook.PageCount);

            // Using the Books custom query operator
            var publishers2 = from publisher in SampleData.Publishers
                              select new
                              {
