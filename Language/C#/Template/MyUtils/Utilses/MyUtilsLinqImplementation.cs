...
namespace WindowsFormsApp0
{
    ...
    public static class MyUtilsLinqImplementation
    {
        ...
        public static TAccumulate MyAggregate<TSource, TAccumulate>
            (this IEnumerable<TSource> sequence, Func<TAccumulate, TSource, TAccumulate> func)
        {
        ...
        public static TAccumulate MyAggregate<TSource, TAccumulate>
            (this IEnumerable<TSource> sequence, TAccumulate seed, Func<TAccumulate, TSource, TAccumulate> func)
        {
